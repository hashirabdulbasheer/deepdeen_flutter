...
//        fontFamily: 'Georgia',
        textTheme: TextTheme(
            ...
            caption:
                TextStyle(fontSize: 16.0, color: Colors.white, height: 1.5)),
      ),
      initialRoute: DeepDeenHomeScreen.routeName,
      routes: {
        DeepDeenHomeScreen.routeName: (context) => DeepDeenHomeScreen(),
        DeepDeenDashboardScreen.routeName: (context) =>
            DeepDeenDashboardScreen(),
        DeepDeenVideoPlayerScreen.routeName: (context) =>
            DeepDeenVideoPlayerScreen(),
